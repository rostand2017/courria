$(document).ready(function() {
	...
	$(document).on('submit', '#formPartner', function (e) {
		e.preventDefault();
    ...
    $(document).on('click','#addPartner', function (e) {
        ...
        $('.titleForm').text("Ajouter un type de partenariat");
        UIkit.modal('#modalPartner').show();
    });
    ...
    $(document).on('click','.editPartner', function (e) {
        ...
        $('.titleForm').text("Modifier le type de partenariat");
