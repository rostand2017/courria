$(document).ready(function() {
    ...
    $(document).on('click','.deleteEmail', function (e) {
        ...
        var url = $(this).data('url'),
            id = $(this).data('id');
        mess = "Êtes vous sûr de vouloir supprimer cette adresse email?";
    ...
    $(document).on('click','.deleteProduct', function (e) {
        ...
        var url = $(this).data('url'),
            id = $(this).data('id');
        mess = "Êtes vous sûr de vouloir supprimer cette suggestion?";
        UIkit.modal.confirm(mess, function(){
            if(url!=''&&id!=''){
                $.ajax({
                    type: 'post',
    ...
    $(document).on('click','#addCustomer', function (e) {
        ...
        $('#idCustomer').val('');
        $('#action').val('add');
        $('.titleForm').text("AJOUTER UNE NOUVELLE SUGGESTION");
        $('.sendBtn').text("AJOUTER");
        UIkit.modal('#modalCustomer').show();
    });
    $(document).on('click','.editProduct', function (e) {
        e.preventDefault();
        var nom = $(this).data('sujet'),
        ...
        $('.titleForm').text("MODIFIER UNE SUGGESTION");
